---
name: improve-svg
description: Run one cycle of the continuous tikzjs SVG rendering improvement loop. Use when improving SVG rendering quality, fixing failing fixtures, or implementing missing TikZ features.
---
